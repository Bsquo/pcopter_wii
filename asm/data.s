...
lbl_801ECE54:
	...
	# ROM: 0x1E8F54
	.asciz "NW4R:Pointer Error\nprintBuf(=%p) is not valid pointer."
	.balign 4
...
lbl_801ECE98:
	...
	# ROM: 0x1E8F98
	.asciz "NW4R:Pointer Error\nfontBuf(=%p) is not valid pointer."
	.balign 4
...
lbl_801ECEE0:
	...
	# ROM: 0x1E8FE0
	.asciz "g3d_demolib is not initialized."
...
lbl_801ED040:
	...
	# ROM: 0x1E9140
	.asciz "g3d_demolib::GetResFile: Invalid index '%d'."
	.balign 4
...
lbl_801ED080:
	...
	# ROM: 0x1E9180
	.asciz "NW4R:Failed assertion arenaSize > HEAP_SIZE_OF_SDK_DEMO"
...
lbl_801ED0C4:
	...
	# ROM: 0x1E91C4
	.asciz "NW4R:Failed assertion sUser1Mem.hHeap != MEM_HEAP_INVALID_HANDLE"
	.balign 4
...
lbl_801ED108:
	...
	# ROM: 0x1E9208
	.asciz "[demo] User Heap1:  %p - %p (%d bytes)\n"
...
lbl_801ED184:
	...
	# ROM: 0x1E9284
	.asciz "NW4R:Failed assertion sSysMem.hHeap != MEM_HEAP_INVALID_HANDLE"
	.balign 4
	.4byte 0
...
lbl_801ED1C8:
	...
	# ROM: 0x1E92C8
	.asciz "[demo] System Heap: %p - %p (%d bytes)\n"
...
lbl_801ED25C:
	...
	# ROM: 0x1E935C
	.asciz "NW4R:Failed assertion ! sbUseSystemHeap || mem == MEM1"
	.balign 4
...
lbl_801ED2CC:
	...
	# ROM: 0x1E93CC
	.asciz "demo::Free: specified pointer(=%p) is not allocated on demolib heap."
	.balign 4
...
lbl_801ED3E4:
	...
	# ROM: 0x1E94E4
	.asciz "MEM1 heap allocation error.\n"
	.balign 4
...
lbl_801ED410:
	...
	# ROM: 0x1E9510
	.asciz "MEM2 heap allocation error.\n"
	.balign 4
...
lbl_801ED43C:
	...
	# ROM: 0x1E953C
	.asciz "OS heap allocation error.\n"
	.balign 4
...
lbl_801ED8F0:
	...
	# ROM: 0x1E99F0
	.asciz "<< NW4R    - SND \tfinal   build: Dec 19 2007 09:43:28 (0x4199_60831) >>"
...
lbl_801EDB00:
	...
	# ROM: 0x1E9C00
	.asciz "<< NW4R    - EF \tfinal   build: Dec 19 2007 09:38:59 (0x4199_60831) >>"
	.balign 4
...
lbl_801EE0B0:
	...
	# ROM: 0x1EA1B0
	.asciz "<< NW4R    - LYT \tfinal   build: Dec 19 2007 09:36:49 (0x4199_60831) >>"
...
lbl_801EEB80:
	...
	# ROM: 0x1EAC80
	.asciz "<< RVL_SDK - HBM \trelease build: Jul  9 2007 12:47:26 (0x4199_60726) >>"
...
lbl_801F1E80:
	...
	# ROM: 0x1EDF80
	.asciz "<< NW4R    - G3D \tfinal   build: Dec 19 2007 09:31:42 (0x4199_60831) >>"
