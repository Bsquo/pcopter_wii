...
/* 80064494 00055414  4B FB 50 95 */	bl GetInstance__10CMarkerMgrFv
/* 80064498 00055418  4B FF 8C 61 */	bl Release__10CMarkerMgrFv
...
/* 80064504 00055484  4B FB 50 25 */	bl GetInstance__10CMarkerMgrFv
...
/* 80064520 000554A0  4B FF 8D 2D */	bl AddGrpByPos__10CMarkerMgrFiiPc6CVFlag8CVVector
...
/* 80064598 00055518  4B FB 4F 91 */	bl GetInstance__10CMarkerMgrFv
...
/* 800645B4 00055534  4B FF 8B 99 */	bl AddGrpByAct__10CMarkerMgrFiiPc6CVFlag8CVVector
...
/* 80064600 00055580  4B FB 4F 29 */	bl GetInstance__10CMarkerMgrFv
...
/* 80064618 00055598  4B FF 8C E9 */	bl AddPosByAct__10CMarkerMgrFiiPc6CVFlag8CVVector
...
/* 8006469C 0005561C  4B FB 4E 8D */	bl GetInstance__10CMarkerMgrFv
...
/* 800646BC 0005563C  4B FF 8B 91 */	bl AddGrpByPos__10CMarkerMgrFiiPc6CVFlag8CVVector
...
/* 8006480C 0005578C  4B FE F1 6D */	bl PutActorDirect__8CScenaryFiiff8CVVector
...
/* 8006482C 000557AC  4B FB 10 E5 */	bl GetInstance__11CScenaryMgrFv
...
/* 80064860 000557E0  4B FC 8B 45 */	bl StartSound__10CVSoundMgrFPciii
...
/* 80064894 00055814  4B FC 8B 11 */	bl StartSound__10CVSoundMgrFPciii
/* 80064898 00055818  4B FB 1F 8D */	bl GetInstance__10CVTimerMgrFv
/* 8006489C 0005581C  38 80 00 64 */	li r4, 0x64
/* 800648A0 00055820  38 A0 01 68 */	li r5, 0x168
/* 800648A4 00055824  4B FE 88 71 */	bl AddTimer__10CVTimerMgrFUlUl
...
/* 800648C4 00055844  48 05 93 61 */	bl swprintf
/* 800648C8 00055848  4B FB 0F E5 */	bl GetInstance__11CVLayoutMgrFv
...
/* 800648D8 00055858  4B FC AA E9 */	bl SetText__11CVLayoutMgrFPcPcPUs
...
/* 80064908 00055888  4B FC 8A 9D */	bl StartSound__10CVSoundMgrFPciii
lbl_8006490C:
/* 8006490C 0005588C  4B FB 10 05 */	bl GetInstance__11CScenaryMgrFv
...
/* 8006491C 0005589C  4B FB 0F F5 */	bl GetInstance__11CScenaryMgrFv
...
/* 800649AC 0005592C  4B FB 0F 65 */	bl GetInstance__11CScenaryMgrFv
...
lbl_80064B04:
/* 80064B04 00055A84  4B FB 1D 21 */	bl GetInstance__10CVTimerMgrFv
/* 80064B08 00055A88  38 80 00 64 */	li r4, 0x64
/* 80064B0C 00055A8C  4B FE 86 E9 */	bl GetTime__10CVTimerMgrFUl
...
lbl_80064B20:
/* 80064B20 00055AA0  4B FB 0D F1 */	bl GetInstance__11CScenaryMgrFv
...
func_80064B38:
/* 80064B38 00055AB8  4B FB 0D 75 */	bl GetInstance__11CVLayoutMgrFv
...
/* 80064B4C 00055ACC  4B FC A7 FD */	bl SetState__11CVLayoutMgrFPci
...
/* 80064B80 00055B00  4B FC E9 5D */	bl CheckDownMap__8CVPadMgrFlUlUl
/* 80064B84 00055B04  2C 03 00 00 */	cmpwi r3, 0x0
/* 80064B88 00055B08  41 82 01 40 */	beq func_80064CC8
/* 80064B8C 00055B0C  4B FB 0D 85 */	bl GetInstance__11CScenaryMgrFv
...
func_80064CC8:
/* 80064CC8 00055C48  4B FB 48 61 */	bl GetInstance__10CMarkerMgrFv
/* 80064CCC 00055C4C  38 80 00 00 */	li r4, 0x0
/* 80064CD0 00055C50  38 A0 00 00 */	li r5, 0x0
/* 80064CD4 00055C54  4B FF 87 5D */	bl SetVisible__10CMarkerMgrFii
/* 80064CD8 00055C58  4B FB 48 51 */	bl GetInstance__10CMarkerMgrFv
...
/* 80064CEC 00055C6C  4B FF 87 45 */	bl SetVisible__10CMarkerMgrFii
/* 80064CF0 00055C70  4B FB 48 39 */	bl GetInstance__10CMarkerMgrFv
...
/* 80064D08 00055C88  4B FF 87 29 */	bl SetVisible__10CMarkerMgrFii
/* 80064D0C 00055C8C  48 00 01 20 */	b func_80064E2C
lbl_80064D10:
/* 80064D10 00055C90  4B FB 0B 9D */	bl GetInstance__11CVLayoutMgrFv
...
/* 80064D24 00055CA4  4B FC A6 25 */	bl SetState__11CVLayoutMgrFPci
/* 80064D28 00055CA8  4B FB 0B E9 */	bl GetInstance__11CScenaryMgrFv
...
/* 80064D5C 00055CDC  4B FB 0B 51 */	bl GetInstance__11CVLayoutMgrFv
/* 80064D60 00055CE0  7F E5 FB 78 */	mr r5, r31
/* 80064D64 00055CE4  38 9D 00 6B */	addi r4, r29, 0x6b
/* 80064D68 00055CE8  4B FC A5 01 */	bl SetVisible__11CVLayoutMgrFPci
/* 80064D6C 00055CEC  4B FB 47 BD */	bl GetInstance__10CMarkerMgrFv
/* 80064D70 00055CF0  38 80 00 00 */	li r4, 0x0
/* 80064D74 00055CF4  38 A0 00 01 */	li r5, 0x1
/* 80064D78 00055CF8  4B FF 87 61 */	bl SetForceVisible__10CMarkerMgrFii
/* 80064D7C 00055CFC  4B FB 47 AD */	bl GetInstance__10CMarkerMgrFv
/* 80064D80 00055D00  38 80 00 01 */	li r4, 0x1
/* 80064D84 00055D04  38 A0 00 00 */	li r5, 0x0
/* 80064D88 00055D08  4B FF 86 A9 */	bl SetVisible__10CMarkerMgrFii
/* 80064D8C 00055D0C  4B FB 47 9D */	bl GetInstance__10CMarkerMgrFv
/* 80064D90 00055D10  38 80 00 02 */	li r4, 0x2
/* 80064D94 00055D14  38 A0 00 00 */	li r5, 0x0
/* 80064D98 00055D18  4B FF 86 99 */	bl SetVisible__10CMarkerMgrFii
/* 80064D9C 00055D1C  4B FB 0B 75 */	bl GetInstance__11CScenaryMgrFv
...
/* 80064E04 00055D84  4B FB 0B 0D */	bl GetInstance__11CScenaryMgrFv
...
/* 80064E20 00055DA0  4B FB 0C ED */	bl SetState__10CSceneGameFi
...
/* 80064E9C 00055E1C  4B FD FE 71 */	bl __dt__8CScenaryFv
