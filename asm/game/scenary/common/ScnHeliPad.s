...
/* 800635E0 00054560  4B FC 8D D9 */	bl GetElement__8CVScriptFPc
...
/* 800635F0 00054570  4B FB 23 85 */	bl GetInstance__10CVActorMgrFv
/* 800635F4 00054574  38 80 00 0A */	li r4, 0xa
/* 800635F8 00054578  4B FC A2 C9 */	bl GetStart__10CVActorMgrFi
...
/* 80063618 00054598  4B FC 8C 0D */	bl GetParam__15CVScriptElementFi
...
/* 80063648 000545C8  4B FB 6B D1 */	bl __as__8CVVectorFRC8CVVector
lbl_8006364C:
...
/* 8006366C 000545EC  4B FB 23 09 */	bl GetInstance__10CVActorMgrFv
/* 80063670 000545F0  7F C4 F3 78 */	mr r4, r30
/* 80063674 000545F4  38 A0 00 0A */	li r5, 0xa
/* 80063678 000545F8  4B FC A2 C1 */	bl GetNext__10CVActorMgrFP7CVActori
...
/* 80063694 00054614  4B FC 30 CD */	bl __ct__6CVFlagFv
/* 80063698 00054618  4B FB 5E 91 */	bl GetInstance__10CMarkerMgrFv
/* 8006369C 0005461C  4B FF 9A 5D */	bl Release__10CMarkerMgrFv
/* 800636A0 00054620  38 61 00 08 */	addi r3, r1, 0x8
/* 800636A4 00054624  38 80 FF FF */	li r4, -0x1
/* 800636A8 00054628  4B FC 30 D1 */	bl __dt__6CVFlagFv
...
/* 80063710 00054690  48 04 F9 A5 */	bl _savegpr_26
...
lbl_8006374C:
/* 8006374C 000546CC  4B FB 30 D9 */	bl GetInstance__10CVTimerMgrFv
/* 80063750 000546D0  38 80 00 64 */	li r4, 0x64
/* 80063754 000546D4  4B FE 9A A1 */	bl GetTime__10CVTimerMgrFUl
...
lbl_80063768:
/* 80063768 000546E8  4B FB 21 A9 */	bl GetInstance__11CScenaryMgrFv
...
func_80063780:
/* 80063780 00054700  4B FB 21 2D */	bl GetInstance__11CVLayoutMgrFv
...
/* 80063794 00054714  4B FC BB B5 */	bl SetState__11CVLayoutMgrFPci
/* 80063798 00054718  4B FB 21 DD */	bl GetInstance__10CVActorMgrFv
/* 8006379C 0005471C  38 80 00 0A */	li r4, 0xa
/* 800637A0 00054720  4B FC A1 21 */	bl GetStart__10CVActorMgrFi
...
/* 800637C8 00054748  4B FC 30 2D */	bl Check__6CVFlagFUs
...
/* 800637DC 0005475C  4B FC 30 19 */	bl Check__6CVFlagFUs
...
/* 800637F4 00054774  4B FC 2F D1 */	bl Set__6CVFlagFUsi
...
/* 80063804 00054784  4B FB 10 E9 */	bl GetInstance__10CVSoundMgrFv
...
/* 80063818 00054798  4B FC 9B 8D */	bl StartSound__10CVSoundMgrFPciii
/* 8006381C 0005479C  4B FB 10 25 */	bl GetInstance__11CVEffectMgrFv
...
/* 80063834 000547B4  4B FC DC E9 */	bl SetPos__11CVEffectMgrFPcfff
/* 80063838 000547B8  4B FB 10 09 */	bl GetInstance__11CVEffectMgrFv
/* 8006383C 000547BC  38 9F 00 25 */	addi r4, r31, 0x25
/* 80063840 000547C0  38 A0 00 00 */	li r5, 0x0
/* 80063844 000547C4  4B FC DB 65 */	bl StartEffect__11CVEffectMgrFPci
...
/* 80063864 000547E4  4B FB 22 A9 */	bl SetState__10CSceneGameFi
/* 80063868 000547E8  93 5D 00 08 */	stw r26, 0x8(r29)
/* 8006386C 000547EC  48 00 00 48 */	b func_800638B4
lbl_80063870:
/* 80063870 000547F0  4B FB 2F B5 */	bl GetInstance__10CVTimerMgrFv
/* 80063874 000547F4  38 80 00 64 */	li r4, 0x64
/* 80063878 000547F8  38 A0 01 68 */	li r5, 0x168
/* 8006387C 000547FC  4B FE 98 99 */	bl AddTimer__10CVTimerMgrFUlUl
...
/* 8006389C 0005481C  48 05 A3 89 */	bl swprintf
/* 800638A0 00054820  4B FB 20 0D */	bl GetInstance__11CVLayoutMgrFv
...
/* 800638B0 00054830  4B FC BB 11 */	bl SetText__11CVLayoutMgrFPcPcPUs
...
/* 800638D8 00054858  4B FB 20 39 */	bl GetInstance__11CScenaryMgrFv
...
/* 8006391C 0005489C  48 04 F6 75 */	bl __cvt_fp2unsigned
/* 80063920 000548A0  7C 7C 1B 78 */	mr r28, r3
/* 80063924 000548A4  4B FB 1F ED */	bl GetInstance__11CScenaryMgrFv
...
lbl_80063934:
/* 80063934 000548B4  4B FB 20 41 */	bl GetInstance__10CVActorMgrFv
/* 80063938 000548B8  7F C4 F3 78 */	mr r4, r30
/* 8006393C 000548BC  38 A0 00 0A */	li r5, 0xa
/* 80063940 000548C0  4B FC 9F F9 */	bl GetNext__10CVActorMgrFP7CVActori
...
/* 80063974 000548F4  48 04 F7 8D */	bl _restgpr_26
...
/* 800639D4 00054954  4B FE 13 39 */	bl __dt__8CScenaryFv
