// Credits to kiwi515: https://github.com/kiwi515/Caddie/blob/layout-tools/include/lib/revolution/KPAD/KPAD.h
...
s32 KPADRead(s32 chan, KPADStatus* status, s32);
void KPADInit();
void KPADSetPosParam(f32 radius, f32 sensitivity, s32 controller);
